          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                Sua parceira em
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400"> impressão 3D</span>
              </h1>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                A IP3D é especializada em peças, componentes e serviços de impressão 3D. 
                Oferecemos produtos de alta qualidade para impressoras Bambu Lab, Creality 
                e outras marcas, além de serviços de impressão personalizada para projetos únicos.
              </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-8 leading-tight">
                &ldquo;Democratizar o acesso à impressão 3D de qualidade, oferecendo peças, 
                componentes e serviços que impulsionam a criatividade e a inovação.&rdquo;
              </h2>
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          >
            ...
            <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg">
              Entre em contato conosco e descubra como podemos ajudar no seu projeto de impressão 3D.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511999999999?text=Olá! Gostaria de saber mais sobre os produtos e serviços da IP3D."
                  target="_blank"
