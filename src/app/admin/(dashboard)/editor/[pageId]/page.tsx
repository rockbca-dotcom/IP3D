...
const BLOCK_TYPES = [
  ...
  { type: "home-hero-slider", name: "Hero Slider (Home)", icon: HiOutlinePhotograph, description: "Banners do hero principal", category: "home" },
  { type: "home-trust-bar", name: "Barra de Confiança", icon: HiOutlineCollection, description: "Entrega, pagamento, suporte, garantia", category: "home" },
  { type: "home-categories", name: "Cards de Categorias", icon: HiOutlineViewGrid, description: "Cards com imagem das categorias", category: "home" },
  { type: "home-featured-products", name: "Mais Vendidos", icon: HiOutlineShoppingBag, description: "Grid de produtos mais vendidos", category: "home" },
  { type: "home-category-products", name: "Produtos por Categoria", icon: HiOutlineCollection, description: "Carrosséis de produtos por categoria", category: "home" },
  { type: "home-promo-banner", name: "Banner Promocional", icon: HiOutlineSpeakerphone, description: "Banner de destaque com produto", category: "home" },
  { type: "home-printer-map", name: "Mapa da Impressora", icon: HiOutlineCube, description: "Mapa interativo de componentes", category: "home" },
];
