...
const defaultLinkGroups = [
  {
    title: "Soluções",
    links: [
      { href: "/categorias/componentes-bambu-lab", label: "Hotends e Bicos" },
      { href: "/categorias/componentes-creality", label: "Componentes Eletrônicos" },
      { href: "/categorias/componentes-universais", label: "Peças Mecânicas" },
      { href: "/categorias/impressoras-3d", label: "Superfícies de Impressão" },
      { href: "/categorias/impressoras-3d-equipamentos", label: "Impressoras 3D" },
